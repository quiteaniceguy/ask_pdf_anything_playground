...
**YOU ARE IN: `arttutorthingy/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/arttutorthingy/` (rig root) or other directories
...
**Your mail address:** `arttutorthingy/polecats/obsidian`
**Your rig:** arttutorthingy
**Your Witness:** `arttutorthingy/witness`
...
| Ask Witness for help | `gt mail send arttutorthingy/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`arttutorthingy/witness`) when:
...
```bash
gt mail send arttutorthingy/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
